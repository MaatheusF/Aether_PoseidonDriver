...
// Use a single, global portMUX for critical sections in the DS18B20 driver.
// The mutex is defined in the .c implementation file. These macros just
// enter/exit the critical section using that global mutex.
extern portMUX_TYPE ds18b20_mux;
